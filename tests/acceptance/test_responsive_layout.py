...
class TestWideLayout:
    ...
    async def test_wide_layout_horizontal(self):
        ...
        pytest.skip("not implemented — wide layout must use horizontal panel arrangement")

    @pytest.mark.asyncio
    async def test_wide_stream_panel_2fr(self):
        """At >= 120 cols, stream panel has width 2fr."""
        pytest.skip("not implemented — stream panel must be 2fr in wide layout")

    @pytest.mark.asyncio
    async def test_wide_station_panel_1fr(self):
        """At >= 120 cols, station panel has width 1fr."""
        pytest.skip("not implemented — station panel must be 1fr in wide layout")

    @pytest.mark.asyncio
    async def test_wide_message_panel_10_lines(self):
        """At >= 120 cols, message panel has height 10."""
        pytest.skip("not implemented — message panel must be 10 lines in wide layout")
...
class TestMediumLayout:
    ...
    async def test_medium_stream_panel_3fr(self):
        ...
        pytest.skip("not implemented — stream panel must be 3fr in medium layout")

    @pytest.mark.asyncio
    async def test_medium_station_panel_2fr(self):
        """At 80-119 cols, station panel has width 2fr."""
        pytest.skip("not implemented — station panel must be 2fr in medium layout")

    @pytest.mark.asyncio
    async def test_medium_message_panel_8_lines(self):
        """At 80-119 cols, message panel has height 8."""
        pytest.skip("not implemented — message panel must be 8 lines in medium layout")
...
class TestNarrowLayout:
    ...
    async def test_narrow_layout_vertical(self):
        ...
        pytest.skip("not implemented — narrow layout must use vertical panel arrangement")

    @pytest.mark.asyncio
    async def test_narrow_station_panel_hidden(self):
        """At < 80 cols, station panel is hidden (display: none)."""
        pytest.skip("not implemented — station panel must be hidden in narrow layout")

    @pytest.mark.asyncio
    async def test_narrow_message_panel_6_lines(self):
        """At < 80 cols, message panel has height 6."""
        pytest.skip("not implemented — message panel must be 6 lines in narrow layout")

    @pytest.mark.asyncio
    async def test_narrow_tab_switching(self):
        """At < 80 cols, panels can be switched via tab bar."""
        pytest.skip("not implemented — narrow mode must provide tab switching between panels")
...
class TestResizeHandling:
    ...
    async def test_resize_triggers_layout_update(self):
        ...
        pytest.skip("not implemented — app must handle on_resize to update layout")

    @pytest.mark.asyncio
    async def test_resize_wide_to_narrow(self):
        """Resizing from wide to narrow switches to vertical layout."""
        pytest.skip(
            "not implemented — layout must transition from horizontal to vertical on resize"
        )
    ...
    async def test_resize_narrow_to_wide(self):
        ...
        pytest.skip(
            "not implemented — layout must transition from vertical to horizontal on resize"
        )
