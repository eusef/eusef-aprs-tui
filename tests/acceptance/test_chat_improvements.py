...
from aprs_tui.core.chat_store import save_chat, load_chat, delete_chat, list_chat_callsigns
...
class TestLazyChatCreation:
    ...
    async def test_chat_screen_does_not_call_save_directly(self):
        ...
        assert False, "not implemented — ChatScreen must not call save_chat directly"
